...
<html>
  ...
  <link rel="stylesheet" href="https://gw.alipayobjects.com/os/s/prod/i/index-815c8.css" /></head>
...
<div class="actions">
  <a class="downloads" style="display:block" href="alipays://platformapi/startapp?appId=20000067&url=<?php echo  urlencode('https://openauth.alipay.com/oauth2/publicAppAuthorize.htm?app_id=2019031363525423&scope=auth_user&state='.urlencode(urlencode('https://6.mxin.ltd/login/alipay?uuid='.$uuid)).'&redirect_uri=https%3A%2F%2Fcoding.mxin.ltd%2F');?> ">打开支付宝</a>
...
<div class="footer">
  <div class="links">
    ...
    </a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="https://cshall.alipay.com/lab/help_detail.htm?help_id=201602386999">服务协议更新</a>
  </div>
...
webpackJsonp([1, 0], [function(e, t, o) {
    ...
    console.log(p);
    var w = function() {
        window.Tracker && (window.Tracker.mPageState = s.
    default.getHash("from")),
        window.Tracker && window.Tracker.start(),
        window.onerror = function(e) {
            u.
        default.log("jsError:JS\u9519\u8bef", {
    ...
    v = function() {
        if (h) return void i.
    default.log("alreadyOpen");
        if (S) {
            i.
        default.log("\u652f\u4ed8\u5b9d\u5185"),
            u.
        default.log("isInAlipay:\u652f\u4ed8\u5b9d\u5185", {
                url: location.href
            }),
        ...
        default.log("\u53c2\u6570", e),
            t ? u.
        default.onJSBridgeReady(function() {
                if (u.
            default.log("jsapiReady"), i.
            default.log("jsapi ready"), s.
            default.canRunNewCode()) {
                    u.
                default.log("canRunNewCode");
                    var o = "20000067" === t ? {
                        appClearTop: !1,
                        startMultApp: "YES"
                    }: {},
                ...
                default.getAllParams(O),
                    ...
                    s.
                default.getSceneStackInfo(function(o) {
                        if (o && 0 === o.currentIndex) {
                            u.
                        default.log("currentIndex0");
                            var n = !u.
                        default.isNewVersion(null, "10.1.22") && "10000007" === t && !!e.qrcode && u.
                        default.browser.ios;
                            n || (l.closeCurrentApp = !0)
                        } else u.
                    default.log("sceneStackCurrentIndexOther");
                        i.
                    default.log("final", l),
                        setTimeout(function() {
            ...
            default.log("schemeOld:\u7070\u5ea6\u524d"),
                i.
            default.log("scheme old", O),
                setTimeout(function() {
                    window.Tracert.click("c24334.d45356"),
                    p.gotoPage(O, k)
                },
        ...
        default.log("urlOpen:url\u65b9\u5f0f\u6253\u5f00"), i.
        default.log("url open", O), setTimeout(function() {
                window.Tracert.click("c24334.d45356"),
                location.replace(O)
            },
            600))
        ...
        default.log("\u53c2\u6570", o),
            ...
            function() {
                ...
                u.
            default.log("openButtonClick:\u6253\u5f00\u652f\u4ed8\u5b9d\u6309\u94ae\u70b9\u51fb"),
                p.gotoPage(O, k)
            }),
            window.Tracert.click("c24334.d45356"),
            p.gotoPage(O, k)
    ...
    b = function() {
        ...
        i.
    default.log("navigator.language", navigator.language);
        var t = urlParams.language || "zh-CN";
        i.
    default.log("langParam", t);
    ...
    l.isNewVersion = function(e, t) {
        ...
        try {
            if (/AliApp\(AP/.test(o)) {
                ...
                if (a.indexOf(") ").length === -1) return i.
            default.log("version not found"),
                !1;
                var r = a.split(") ")[0];
                if (r.indexOf(".").length === -1) return i.
            default.log("version get error"),
                !1;
                var l = r.match(/.*\..*\./);
                if (!l[0]) return i.
            default.log("not match version"),
                !1;
                var u = l[0].substring(0, l[0].length - 1);
                i.
            default.log("currentVersion", u);
                var d = n(u),
                s = n(t);
                return d >= s ? (i.
            default.log(u + ">=" + t), !0) : (i.
            ...
            return i.
        default.log("can not find AliApp(AP"),
            !1
        } catch(e) {
            return ! 1
        }
...
function(e, t, o) { !
    ...
    function() {
        return function(e) {
            ...
            function r(e) {
                c.
            default.log("in iframe func", e),
                _ || (c.
            default.log("create iframe"), _ = x.createElement("iframe"), _.id = "callapp_iframe_" + Date.now(), _.frameborder = "0", _.style.cssText = "display:none;border:0;width:0;height:0;", x.body.appendChild(_)),
                _.src = e
            }
            function i(e) {
            ...
            p = "";
            p = d.
        default.getHash("alidebug") && d.
        default.getHash("ua") ? d.
        default.getHash("ua"):
            ...
            f.gotoPage = function(e, t, o) {
                var n = e;
                c.
            default.log("targetUrl", e);
                var u = g && v && !y,
                d = g && !!p.match(/samsung/i) && a(m, "4.3") >= 0 && a(m, "4.5") < 0,
                s = h && a(m, "9.0") >= 0 && b;
                if (c.
            default.log("isOriginalChrome", u), c.
            default.log("fixUgly", d), c.
            default.log("ios9SafariFix", s), c.
            default.log("forceIntent", o), u || o) {
                    var f = n.substring(0, n.indexOf("://")),
                    w = "#Intent;scheme=" + f + ";package=" + t + ";end";
                    n = n.replace(/.*?\:\/\//, "intent://"),
                    n += w,
                    c.
                default.log("Intent", n)
                }
                if (s) {
                    if (l(n)) return window.Tracker && window.Tracker.click && window.Tracker.click("not_schema"),
                    void c.
                default.log("not schema");
                    setTimeout(function() {
                        i(n)
                    },
                    100)
                } else if (0 === n.indexOf("intent:")) c.
            default.log("jump intent"),
                setTimeout(function() {
                ...
                100);
                    ...
                    x.test(n.toLocaleLowerCase()) ? c.
                default.log("schema is url"):
                    (c.
                default.log("call in iframe"), r(n))
                }
            },
            e.exports = f
        },
        ...
        function(e, t, o) {
            ...
            function p(e, t, o) {
                var n = o.css,
                a = o.sourceMap,
                r = void 0 === t.convertToAbsoluteUrls && a; (t.convertToAbsoluteUrls || r) && (n = x(n)),
...
function(e, t, o) {
    ...
    d = function() {
        if (i.
    default.log("\u6536\u94f6\u53f0"), !u) return l("body").append('<div id="h5cashierBack" class="h5cashier-header">\n      <h1>\u652f\u4ed8\u5b9d</h1>\n      <i class="arrow-back">\u8fd4\u56de</i>\n    </div>'),
        l("#h5cashierBack").on("click",
        function(e, t) {
            e.preventDefault(),
            "sdk" === window.urlParams.backTarget ? (i.
        default.log("\u9000\u51fasdk\u6253\u5f00\u7684\u9875\u9762"), location.href = "sdklite://h5quit") : window.history.back()
        },
        !1),
        u = !0,
        !0
...
function(e, t, o) {
    ...
    d = function() {
        if (!u) {
            r.
        default.log("kstq_PV:\u8003\u751f\u7279\u6743\u6e20\u9053PV");
            var e = navigator.userAgent.toLocaleLowerCase();
            return e.indexOf("alipay") > 0 ? (r.
        default.log("kstq_in_alipay:\u8003\u751f\u7279\u6743\u6e20\u9053_\u652f\u4ed8\u5b9d\u5185\u6253\u5f00"), l.
        default.log("kstq:in alipay"), r.
        default.onJSBridgeReady(function() {
                l.
            default.log("kstq:start push window"),
        ...
        default.log("kstq_out_alipay:\u8003\u751f\u7279\u6743\u6e20\u9053_\u652f\u4ed8\u5b9d\u5916\u6253\u5f00"), l.
        default.log("kstq:out of alipay"), !1)
        }
        u = !0
    };
    t.
...
function(e, t, o) {
    ...
    d = function() {
        if (!u) {
            r.
        default.log("zxd_PV:\u52a9\u5b66\u8d37\u6e20\u9053PV");
            var e = navigator.userAgent.toLocaleLowerCase();
            return e.indexOf("alipay") > 0 ? (r.
        default.log("zxd_in_alipay:\u52a9\u5b66\u8d37\u6e20\u9053_\u652f\u4ed8\u5b9d\u5185\u6253\u5f00"), l.
        default.log("zxd:in alipay"), r.
        default.onJSBridgeReady(function() {
                l.
            default.log("zxd:start push window"),
                AlipayJSBridge.call("pushWindow", {
                    url: "alipays://platformapi/startapp?appId=20000047&sourceId=S&publicId=2017052407330286"
                })
            }), !1) : (r.
        default.log("zxd_out_alipay:\u52a9\u5b66\u8d37\u6e20\u9053_\u652f\u4ed8\u5b9d\u5916\u6253\u5f00"), l.
        default.log("zxd:out of alipay"), !1)
        }
        u = !0
    };
    t.
...
function(e, t, o) {
    ...
    s = r.
default.getHash("cid") || "wap_dc",
    c = "com.eg.android.AlipayGphone",
    f = function() {
        var e = "https://t.alipayobjects.com/L1/71/100/and/alipay_wap_dc.apk";
        return r.
    default.browser.mobile ? (r.
    default.browser.ios ? (l.
    default.log("download", "IOS"), e = "itms-apps://itunes.apple.com/app/zhi-fu-bao/id333206289?mt=8") : r.
    default.browser.android ? (l.
    ...
    default.log("download", "winphone"), e = "http://www.windowsphone.com/zh-cn/store/app/%E6%94%AF%E4%BB%98%E5%AE%9D%E9%92%B1%E5%8C%85/8ce634b0-1861-4006-a31d-93c5a2c6073b") : l.
    default.log("download", "\u5176\u4ed6"), e) : void l.
    default.log("download", "\u975emobile")
    },
    p = function() {
        return u(".download").on("click",
        function() {
            if (window.Tracert.click("c24334.d45355"), r.
        default.log("downloadClick:\u4e0b\u8f7d\u6309\u94ae\u70b9\u51fb"), u(void 0).hasClass("update") ? l.
        default.log("update"):
            l.
        default.log("download"), window.urlParams && "zxd" === window.urlParams.pageSkin && r.
        default.log("zxd_download_click:\u52a9\u5b66\u8d37\u6e20\u9053\u5305\u4e0b\u8f7d\u70b9\u51fb"), window.urlParams && "kstq" === window.urlParams.pageSkin && r.
        default.log("kstq_download_click:\u8003\u751f\u7279\u6743\u6e20\u9053\u5305\u4e0b\u8f7d\u70b9\u51fb"), /AliApp\(TB/.test(window.navigator.userAgent)) return l.
        default.log("taobao container"),
            void r.
        default.loadJS("https://g.alicdn.com/mtb/lib-windvane/3.0.0/windvane.js",
            function() {
                window.WindVane && window.WindVane.call("TBDeviceInfo", "getInfo", {},
                function(e) { / ^212200@taobao / .test(e.ttid) ? location.href = "https://play.google.com/store/apps/details?id=" + c: location.href = f()
                },
                function(e) {
                    r.
                default.log("taobaoDownloadError")
                })
            });
            var e = f();
            if (window.injs && "function" == typeof window.injs.downloadApp && r.
        default.browser.android) try {
                var t = {};
                t.appName = c,
                t.url = e,
...
function(e, t, o) {
    ...
    default)();
        return w.
    default.log("middleware", e, t, o, n, a, i),
        e && t && o && n && a && i
    };
    t.
default = v,
...
function(e, t, o) {
    ...
    l = window.Zepto,
    u = function() {
        return window.urlParams.nojump && "true" === String(window.urlParams.nojump) ? (i.
    default.log("noJump", !0), l(".open").remove(), !1) : "publicmessage" !== window.urlParams.comeFrom || (i.
    default.log("comeFrom publicmessage", !0), !1)
    };
    t.
default = u,
    e.exports = t.
...
function(e, t, o) {
    ...
    s = function() {
        ...
        n = o && r.
    default.isNewVersion(!1, window.urlParams.minVersion),
        a = "lowVersionMessage" === window.urlParams.froms;
        if (l.
    default.log("minVersion", t, o, n, a), t && o && !n || a) {
            d(".open").hide();
...
function(e, t, o) {
    ...
    default.getHash("from"),
        scheme: r.
    default.getHash("scheme"),
        rc: r.
    default.getHash("rc"),
        iframeSrc: r.
    default.getHash("iframeSrc"),
        cid: r.
    default.getHash("cid") || "wap_dc",
        nojump: r.
    default.getHash("nojump"),
        appId: r.
    default.getHash("appId"),
        pageSkin: r.
    default.getHash("pageSkin"),
        backTarget: r.
    default.getHash("backTarget"),
        minVersion: r.
    default.getHash("minVersion"),
        downloadPageTitle: r.
    default.getHash("downloadPageTitle") || "\u652f\u4ed8\u5b9d",
        url: r.
    default.getHash("url"),
        comeFrom: r.
    default.getHash("comeFrom"),
        hideOpen: r.
    default.getHash("hideOpen"),
        mk: r.
    default.getHash("mk"),
        language: r.
    default.getHash("language") || "zh-CN"
    };
    window.urlParams = c;
    var f = function() {
        l.
    default.log("urlParams", c);
        var e = !0;
        if (c.froms && r.
    default.log(c.froms), c.pageSkin) {
            var t = d.
        default[c.pageSkin]; ! t && l.
        default.log("pageSkin is undefined"),
            e = !t || t()
        }
...
function(e, t, o) {
    ...
    g.pop(),
    p.length || l.
default.log("domainListError:\u51e4\u8776\u533a\u5757\u540c\u6b65\u83b7\u53d6\u5931\u8d25"),
    ...
    default.log("not a url"),
        ...
        a = function() {
            ...
            default.getHost(e);
                return !! t && (r.
            default.log("url2", o, t), p.some(function(e) {
                    var o = "." === e[0] ? e: "." + e,
                ...
                return l.
            default.log("ExtraHostError:\u4e0d\u652f\u6301array.some", window.navigator.userAgent),
                !1
            }
        };
    ...
    s.isValidScheme = function(e) {
        if (!e || !/^alipay(s|src|qr|mo)?\:\/\/platformapi\/startapp\?/i.test(e)) return r.
    default.log("isValidScheme null"),
        !1;
        var t = s.getAllParams(e).url;
        return r.
    default.log("url", t),
        !(t && "/" !== t[0] && !s.isValidUrl(t)) || (r.
    default.log("isValidScheme isValidUrl"), !1)
    },
    s.getScheme = function(e) {
        var t = s.getAllParams(e);
        r.
    default.log("getScheme params", t);
        var o = t.cid || "wap_dc",
        n = !!t.nojump,
        ...
        if (!a) {
            ...
            if (!i && l && (i = "20000067"), i) {
                for (var u = "alipays://platformapi/startapp?appId=" + encodeURIComponent(i), d = Object.keys(t), c = 0; c < d.length; c++) {
                    var f = d[c];
                    "appId" !== f && (r.
                default.log("getScheme key", f, t[f]), u += "&" + encodeURIComponent(f) + "=" + encodeURIComponent(t[f]))
                }
                a = u
            }
        }
        return r.
    default.log("isValid", a, s.isValidScheme(a)),
    ...
    s.getSceneStackInfo = function(e) {
        ...
        function(t) {
            r.
        default.log("getSceneStackInfo", t),
            e && e(t)
        })
    },
    t.
