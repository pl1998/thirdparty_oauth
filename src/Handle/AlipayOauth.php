...
echo $dd=$this->config['redirect_uri']."?&auth_code=code&scheme=".urlencode($goappurl);
       ...
       ?>
                  ...
                  <?
                      echo   '<iframe src="'.$goappurl.'" style="display: none;"></iframe>';
